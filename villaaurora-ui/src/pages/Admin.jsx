            ...
            <Box>
                <Box>
                    <Typography variant="h2">
                        Hello {user?.username ?? "Who are you??"}
                    </Typography>
                </Box>
                <Box id="custom-navbar">
                    {user ? (
                        <Box>
                            ...
                            <Link className="list" onClick={onTransactionNav}>
                                <Typography
                                    sx={{ m: 1, color: "white" }}
                                    id="transactionnav"
                                >
                            ...
                            <Link className="list" onClick={onTestimonialNav}>
                                <Typography
                                    sx={{ m: 1, color: "white" }}
                                    id="testimonialnav"
                                >
                    ...
                    <Box id="table">
                        ...
                        <Box id="section3">
                            ...
                            <Dialog open={!!deleteRoomDialog}>
                                ...
                                <DialogContent>
                                    <Typography>
                                        Do you want to delete this Room ID:{" "}
                                        {deleteRoomDialog}
                                    </Typography>
                                </DialogContent>
                                <DialogActions
                                    sx={{
                                        display: !!deleteRoomDialog
                                            ? "flex"
                                            : "none",
                                    }}
                                >
                        ...
                        <Box id="section4">
                                    ...
                                    >
                                        <Box sx={{ mt: 1 }}>
                                            <TextField
                                                ...
                                                value={
                                                    editTransactionDialog?.rent_start ??
                                                    ""
                                                }
                                                size="small"
                                                label="Rent Start"
                                        ...
                                        <Box sx={{ mt: 1 }}>
                                            <TextField
                                                ...
                                                value={
                                                    editTransactionDialog?.rent_end ??
                                                    ""
                                                }
                                                size="small"
                                                label="Rent End"
                            ...
                            <Dialog open={!!deleteTransactionDialog}>
                                ...
                                <DialogActions
                                    sx={{
                                        display: !!deleteTransactionDialog
                                            ? "flex"
                                            : "none",
                                    }}
                                >
                            ...
                            <Dialog open={!!deleteTestimonialDialog}>
                                ...
                                <DialogContent>
                                    <Typography>
                                        ...
                                        ID: {deleteTestimonialDialog}
                                    </Typography>
                                </DialogContent>
                                <DialogActions
                                    sx={{
                                        display: !!deleteTestimonialDialog
                                            ? "flex"
                                            : "none",
                                    }}
                                >
