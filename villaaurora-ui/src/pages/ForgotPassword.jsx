...
export default function ForgotPassword() {
  ...
  return (
    <Box>
        ...
        alignItems: 'center' }} component="form" onSubmit={onSubmit}>

            <Typography variant="h6" sx={{color:'white'}}>Villa Aurora Private Resort</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center' }}>
            <Box sx={{marginLeft: '10px'}}>
                <TextField type="text" value={username} placeholder="Username or Email" sx={{backgroundColor:'white'}} onChange={(e) => setUsername(e.target.value)}/>
            </Box>
            <Box sx={{marginLeft: '10px'}}>
                <TextField type="password" value={password} placeholder="Password" sx={{backgroundColor:'white'}}  onChange={(e) => setPassword(e.target.value)}/>
            </Box>
            <Box>
                <Button variant="contained" sx={{marginLeft: '10px'}} color="success" type="submit">Login</Button>
            </Box>
            </Box>
        </Toolbar>
        </AppBar>
